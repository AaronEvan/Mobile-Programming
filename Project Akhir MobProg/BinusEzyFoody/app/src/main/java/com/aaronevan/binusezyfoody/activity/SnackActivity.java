...
import com.aaronevan.binusezyfoody.adapter.AdapterListSnack;
...
public class SnackActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        listDrinkItems = phd.getData(MyMoney.getStore(), "Snack");
    }
    ...
    private void setRecycle() {
        ...
        adapter = new AdapterListSnack(listDrinkItems, myOrder);
