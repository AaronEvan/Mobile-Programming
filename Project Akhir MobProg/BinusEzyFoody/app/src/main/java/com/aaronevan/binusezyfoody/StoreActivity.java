package com.aaronevan.binusezyfoody;
...
import com.aaronevan.binusezyfoody.activity.MainActivity;
...
public class StoreActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final LatLng jktBinus = new LatLng(-6.200626786640842, 106.78510782104438);
        final MarkerOptions a = new MarkerOptions();
        a.position(jktBinus);
        a.title("Kemanggisan Store");
        LatLng alsBinus = new LatLng(-6.2232004023710585, 106.6488380704966);
        ...
        if(MyMoney.getStore() == 1){
            cameraUpdate = CameraUpdateFactory.newLatLngZoom(jktBinus, 15);
        }else if(MyMoney.getStore() == 2){
            cameraUpdate = CameraUpdateFactory.newLatLngZoom(alsBinus, 15);
        }
        mMap.animateCamera(cameraUpdate);
