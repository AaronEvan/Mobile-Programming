...
import com.aaronevan.binusezyfoody.activity.SnackActivity;
import com.aaronevan.binusezyfoody.binusclass.Product;

import java.util.ArrayList;

public class AdapterListSnack extends RecyclerView.Adapter<AdapterListSnack.MyViewHolder> {
    ...
    public AdapterListSnack(ArrayList<Product> arrdrink, ArrayList<Product> myOrder) {
    ...
    @NonNull
    @Override
    public AdapterListSnack.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
...
//        ImageView imageView =  cardView.findViewById(R.id.idimage);
        ...
        cardView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                ((SnackActivity)cardView.getContext()).finish();
            }
        });
    }
